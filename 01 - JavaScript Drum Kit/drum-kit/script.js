window.addEventListener('keydown', function(e) {
  const audio = document.querySelector(`audio[data-key="${e.keyCode}"]`); // Attribute values must be CSS identifiers or strings
  const key = document.querySelector(`.key[data-key="${e.keyCode}"]`); // backticks for adding variable to string
